<?php 
    ...
    {
        echo $this->Html->link("",
			$this->Html->url('/')."admin/acl/aros/grant_role_permission/" . $this->params['pass'][0] . "/plugin:" . $this->params['named']['plugin'] . "/controller:" . $this->params['named']['controller'] . "/action:" . $this->params['named']['action'],
