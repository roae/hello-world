<?php 
	...
	if(isset($acl_error)){
		...
		echo $this->Html->link("",
			$this->Html->url('/')."admin/acl/aros/deny_user_permission/" . $this->params['pass'][0] . "/plugin:" . $this->params['named']['plugin'] . "/controller:" . $this->params['named']['controller'] . "/action:" . $this->params['named']['action'],
