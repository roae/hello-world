	...
	<div class="buttonPane">
		<div class="lButtons">
			...
			echo $this->Html->link(
				...
				am(array('action'=>'delete',$this->data['AdsGroup']['id']),$this->params['named']),
				array('class'=>'btn_danger','data-confirm'=>'[:delete_city_name:]: '.h($this->data['AdsGroup']['name']).'?','escape'=>false)
			);
			?>
		</div>
		<div class="rButtons">
