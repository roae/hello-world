	...
	<body <?php echo $class ?>>
		<header class="block" id="main-header">
			...
			<div class="col-container">
				<?= $this->Html->link($this->Html->image("logo.png",array('alt'=>'[:logo_alt:]')),array('controller' => 'articles', 'action' => 'index'),array('escape'=>false,'title'=>'[:title_logo:]','id'=>'logo'));?>

				<div id="header-location-select">
					<a href="">Ver cartelera en <span class="current">Culiacán</span></a>
				...
				<ul class="account-container">
					...
					<li>
						<a class="signup" href="">Crear cuenta</a>
					</li>
				</ul>
			</div>
