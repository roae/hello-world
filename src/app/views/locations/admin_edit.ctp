...
<div class="buttonPane">
	<div class="lButtons">
		...
		echo $this->Html->link(
			...
			am(array('action'=>'delete',$this->data['Location']['id']),$this->params['named']),
			array('class'=>'btn_danger','data-confirm'=>'[:delete_location_name:]: '.h($this->data['Location']['name']).'?','escape'=>false)
		);
		?>
	</div>
	<div class="rButtons">
