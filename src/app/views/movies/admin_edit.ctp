...
$this->Html->addCrumb('[:System.admin_movies_edit:]');
	...
	<div class="buttonPane">
		<div class="lButtons">
			...
			echo $this->Html->link(
				...
				am(array('action'=>'delete',$this->data['Movie']['id']),$this->params['named']),
				array('class'=>'btn_danger','data-confirm'=>'[:delete_movie_name:]: '.h($this->data['Movie']['title']).'?','escape'=>false)
			);
			?>
		</div>
		<div class="rButtons">
